              ...
              Row(children: [
                Expanded(
                  child: AnimatedPressButton(
                    onTap: onAccept,
                    child: ElevatedButton(
                      // Keep onPressed = onAccept so button stays RED
                      onPressed: onAccept,
                      style: ElevatedButton.styleFrom(
              ...
              background: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF2A0A0A), AppColors.bg],
                  ),
                ),
                child: Column(
              ...
              delegate: SliverChildListDelegate([
                ...
                Row(children: [
                  ...
                  Expanded(
                    child: ValueListenableBuilder<bool>(
                      valueListenable: widget.availabilityNotifier,
                      builder: (_, available, __) => GestureDetector(
                        onTap: () {
                          Haptics.medium();
                          widget.availabilityNotifier.value = !available;
                        },
                    ...
                    if (snap.connectionState == ConnectionState.waiting) {
                      ...
                      if (rawDate != null) {
                        ...
                        if (dt != null) {
                          ...
                          lastDonationText =
                              '${months[dt.month - 1]} ${dt.day}, ${dt.year} — $hospital';
                        }
                      }
                    }
                    return Container(
                ...
                // Fields — read-only when not editing
                ...
                const SizedBox(height: 10),
                _profileField(
                    Icons.location_on_outlined, 'Location', _locationCtrl,
                    editable: _editMode),
                const SizedBox(height: 24),
...
// Helper for cleaner field display
